...
public class Customer_Account_Details
{
	...
	public Customer_Account_Details()
    {
    }
	...
	public Customer_Account_Details(String FullName,String FathersName,java.sql.Date DOB,String Gender,String PermanentAddress,String PresentAddress,String PANNumber,String MobileNumber,int Landline,String AccountType,int OpeningBalance,int CustomerID,long AccNo,String CardNo,int PIN,String CheckBook,int BranchID)
	{
