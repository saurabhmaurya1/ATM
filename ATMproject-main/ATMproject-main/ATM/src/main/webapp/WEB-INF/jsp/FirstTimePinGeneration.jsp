...
<head>
    ...
    <title>First Time Pin Generation</title>
...
<body>
    <form method="POST" action="/mychangepin">
        <div style="background: linear-gradient(to bottom, #0099ff 0%, #fff 100%); margin-top: 250px; padding:50px; border: 2px solid;"class="container body-content">WELCOME!! Your Account Number: <%=session.getAttribute("customerid")%> 
            <div class="container" style="text-align: center;"><h4 style="text-align: center; font-size: 25px;color: #000;text-transform: uppercase;font-weight: bold;border-radius: 5px;">FIRST TIME PIN GENERATION</h4>
            <div class="row justify-content-start" style="padding-top:10px; text-align: center;">
                <div class="col" style="padding-top:10px; padding-left: 100px;">ENTER CODE  (4 Digits):
                    <label><input type="text" style="width: 150%;" pattern = "^[0-9]{4}$" class="form-control" name="change" id="change"></input></label>
                </div>
            </div>
            <div class="row justify-content-center" style="padding-top:10px;">
                <input type="submit" class="btn btn-primary" name="change" id="change" onclick="getInputValue();" value="GENERATE PIN">
            </div>
            <div class="row justify-content-center" style="padding-top:10px;">
                <a href="/">GO BACK
            </div>
